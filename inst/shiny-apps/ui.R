    ...
    tabItems(
      ...
      tabItem(tabName = "hypetune",
              ...
              column(
                ...
                sliderInput("ga_seed", "Set seed", min = 1, max = 1000, value = 86, step = 1),
      ...
      tabItem(tabName = "trainml",
              ...
              column(width = 3,
                     ...
                     sliderInput("rf_seed", "Set seed", min = 1, max = 1000, value = 86, step = 1),
              ...
              column(
                ...
                tabsetPanel(
                  id = "trainrf_results",
                  tabPanel("Performance metrics", br(), dataTableOutput("train_rfResults")),
